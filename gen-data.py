...
from unico import coalesce_sorted_ranges
...
def main():
  ...
  print('# Generated by gen-data.py.')
...
# Generate terminal double width ranges.
  ...
  print("double_width_codes = [ # Code points with East Asian Width 'W' or 'F'.", end='')
...
class CharInfo:
  __slots__ = ('code', 'name', 'cat', 'comb', 'bidi', 'decomp', 'decimal', 'digit', 'numeric', 'mirror', 'upper', 'lower', 'title')

  def __init__(self, code, name, cat, comb, bidi, decomp, decimal, digit, numeric, mirror, upper, lower, title):
    self.code = code
    self.name = name
    self.cat = cat
    self.comb = comb
